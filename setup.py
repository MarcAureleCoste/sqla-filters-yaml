...
NAME: str = 'sqla-filters-yaml'
VERSION: str = '0.0.1'
DESCRIPTION: str = 'YAML parser for sqla-filters.'
...
setup(
    ...
    url='https://github.com/MarcAureleCoste/sqla-filters-yaml',
